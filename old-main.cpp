...
#define ATUALIZACAO_PROF_SUCESSO -8
#define EXCLUSAO_PROF_SUCESSO -9
#define CAD_DISC_SUCESSO -10
#define ATUALIZACAO_DISC_SUCESSO -11
#define EXCLUSAO_DISC_SUCESSO -12
#define CODIGO_INVALIDO -13
#define CODIGO_INEXISTENTE -14
